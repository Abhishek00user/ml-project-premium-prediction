...
def preprocess_input(input_dict):
    ...
    # same endcoding that we had done in notebook
...
def handle_scaling(age, df):
    ...
    df['income_level'] = None  # since scaler object expects income_level supply it btw we had dropped it during VIF calcualtion
